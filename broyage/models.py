...
class Broyage(models.Model):
    ...
    dif_compt = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    dif_clinker = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    dif_dolomite = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
